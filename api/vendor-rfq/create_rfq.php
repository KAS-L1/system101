...
$data = array(
    "vendor_id" => intval($DB->ESCAPE($_POST['vendor_id'])), // Ensure vendor_id is an integer
    "product_id" => intval($DB->ESCAPE($_POST['product_id'])), // Ensure product_id is an integer
    "requested_quantity" => intval($DB->ESCAPE($_POST['requested_quantity'])), // Ensure requested_quantity is an integer
    "quoted_price" => floatval($DB->ESCAPE($_POST['quoted_price'])), // Ensure quoted_price is a float
