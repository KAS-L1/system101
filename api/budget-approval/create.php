...
$data = array(
    "approval_id" => rand(), // Generate a random ID for new approval entries
    ...
    "approval_status" => $DB->ESCAPE($_POST['approval_status']), // Ensure this is Approved or Rejected
...
if ($approval == "success") {
    ...
    $requisition_status = $data['approval_status'] == 'Approved' ? 'Approve' : 'Decline'; // Ensure status is correct for the requisition
