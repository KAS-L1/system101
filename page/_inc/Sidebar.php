                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseAudit" aria-labelledby="headingTwo"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="layout-sidenav-light.html">Audit Findings</a>
                                <a class="nav-link" href="layout-sidenav-light.html">Audit Recommendations</a>
                        ...
                        <div class="collapse" id="collapseDocument" aria-labelledby="headingThree"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="layout-sidenav-light.html">Document Storage</a>
                                <a class="nav-link" href="layout-sidenav-light.html">Document Retrieval</a>
                                <a class="nav-link" href="layout-sidenav-light.html">Document Disposal</a>
                            </nav>
                        </div>
                        <div class="sb-sidenav-menu-heading">APPS</div>
                        <a class="nav-link" href="vendor_portal.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-store"></i></div>
                            Vendor Portal
                        </a>
                        <a class="nav-link" href="food_beverage_management.php">
