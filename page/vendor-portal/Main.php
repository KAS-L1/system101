    ...
    $new_pos = $db->SELECT_WHERE('purchaseorder', '*', ['status' => 'Ordered']); // Assuming 'Ordered' indicates pending state
    ...
    $orders = $db->SELECT('purchaseorder', '*', 'ORDER BY order_date DESC LIMIT 5'); // Adjusting to correct table name
    ...
    $recent_activities = array_merge($recent_pos, $recent_rfqs, $recent_contracts_log);
    ?>
                                    ...
                                    <tbody>
                                        ...
                                        if (!empty($orders)) {
                                            foreach ($orders as $order) {
                                                echo "<tr>
                                                    <td>PO #{$order['po_id']}</td> <!-- Corrected to po_id -->
                                                    <td>{$order['delivery_date']}</td> <!-- Updated to match your schema -->
                                                    <td>";
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group">
                                ...
                                if (!empty($recent_activities)) {
                                    foreach ($recent_activities as $activity) { // Loop through all recent activities
