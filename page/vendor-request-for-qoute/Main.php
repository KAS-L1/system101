                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <!-- Approve RFQ Button -->
                                                    <button class="btn btn-sm btn-success shadow-sm approveRFQ"
                                                        data-rfq_id="<?= $rfq['rfq_id']; ?>">
                                                        <i class="bi bi-check-circle"></i>
                                                    </button>
                                                    <!-- Reject RFQ Button -->
                                                    <button class="btn btn-sm btn-danger shadow-sm rejectRFQ"
                                                        data-rfq_id="<?= $rfq['rfq_id']; ?>">
                                                        <i class="bi bi-x-circle"></i>
                                                    </button>
                                                    <!-- Remove RFQ Button -->
                                                    <button class="btn btn-sm btn-warning shadow-sm removeRFQ"
                                                        data-rfq_id="<?= $rfq['rfq_id']; ?>">
                                                        <i class="bi bi-trash"></i>
                                                    </button>
                                                </div>
